...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  String _selectedModelConverted = 'Xception';
              ...
              children: <Widget>[
                    ...
                    child: Container(
                        ...
                        child: DottedBorder(
                            ...
                            child: Container(
                              ...
                              width: size.width * (1 / 3),
                              child: Text(
                                '${widget.resultPredict['${_selectedModelConverted} Predicted']}',
                                style: TextStyle(
                                    color: Colors.green,
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      width: size.width,
                      child: ResultsChart(
                        model: _selectedModelConverted,
                        result: widget.resultPredict,
                      ),
                    )),
                Positioned(
                  top: size.height * .05,
